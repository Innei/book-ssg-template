...
import { RiNextjsFill } from "../icons/platform/NextJSIcon"
import { TablerBrandVercel } from "../icons/platform/VercelIcon"
...
const map = [
  ...
  {
    type: "TMDB",
    icon: <SimpleIconsThemoviedatabase className="text-[#0D243F] dark:text-[#5CB7D2]" />,
    test: isTMDBUrl,
  },
  {
    type: "Moz",
...
export const Favicon: Component<FaviconProps> = (props) => {
  ...
  return (
    <span className={clsxm("mx-1 inline-flex [&_svg]:inline [&_svg]:!h-[0.8em]", className)}>
